...
///
/// Uses a Miller-Rabin primality test with a known perfect witness base numbers.
///
/// # Example
/// Basic usage
/// ```
...
pub const fn is_prime(n: u64) -> bool {
    if n == 2 || n == 3 {
        ...
        // This lists of witnesses was taken from https://en.wikipedia.org/wiki/Miller%E2%80%93Rabin_primality_test#Testing_against_small_sets_of_bases.
...
const fn mod_mul(a: u64, b: u64, modulo: u64) -> u64 {
    // Since a and b are u64s the product is guaranteed to fit in a u128,
    // and since modulo is a u64 the downcast at the end is guaranteed to be safe
